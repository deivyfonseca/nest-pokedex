...
export class PokemonService {
  ...
  constructor(
    ...
    // console.log( process.env.DEFAULT_LIMIT ); // Dato obtenido del archivo .env
    // console.log( configService.get('defaultLimit') ); // Dato obtenido de la configuaracion (app.config.ts)
